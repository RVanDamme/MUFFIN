process checkm2 {
    ...
    """
    checkm2 predict --threads ${task.cpus} --input ${bins_assemblies}/* ${dbPathCmd} ${lowmemCmd} --output-directory checkm2_dir/ --database_path /proj/cloacimonetes/NOBACKUP/Arnaud2024/spades_way/uniref100.KO.1.dmnd
    """
}
